...
def get_actor_state_key(actor_type: str, actor_id: str, state_key: str = "state") -> str:
...
def main():
    ...
    if args.dry_run:
        ...
        print(f"  redis-cli -h {args.redis_host} -p {args.redis_port} --scan --pattern 'seeker:*' | xargs redis-cli -h {args.redis_host} DEL")
