...
class TestComposeYaml:
    ...
    def test_services_have_production_profile(self):
        ...
        for service_name in ["seeker-actor-service", "seeker-actor-dapr",
                             "wisdom-service", "wisdom-dapr"]:
...
class TestStubServices:
    ...
    def test_seeker_actor_service_requirements(self):
        ...
        assert req_path.exists(), \
            "src/seeker_actor_service/requirements.txt not found"
...
class TestDaprComponents:
    ...
    def test_conversation_component_exists(self):
        ...
        assert conv_path.exists(), \
            ".dapr/components/conversation.yaml not found"
    ...
    def test_statestore_has_actor_support(self):
        ...
        assert actor_enabled, \
            "statestore.yaml missing actorStateStore: true"
...
class TestMigrationScript:
    ...
    def test_migration_script_exists(self):
        ...
        assert script_path.exists(), \
            "scripts/migrate_state_to_actors.py not found"
